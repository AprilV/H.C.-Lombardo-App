...
7. Do not trigger paid resource expenditure without explicit approval.
...
## Policy References
- Commit behavior is governed by `COMMIT_POLICY.md`.
- Spending behavior is governed by `RESOURCE_EXPENDITURE_POLICY.md`.
