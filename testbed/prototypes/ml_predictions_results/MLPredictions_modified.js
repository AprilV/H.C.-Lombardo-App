        ...
        {(() => {
          ...
          if (finishedGames.length > 0) {
            ...
            const vegasCovered = finishedGames.filter(p => {
              ...
              // If vegas_spread is negative (home favored), actual margin must be more negative
              // If actual margin > vegas_spread, home covered
                ...
                <div className="scorecard-stats">
                  ...
                  <div className="stat-box vegas-stat">
                    ...
                    <div className="stat-content">
                      ...
                      <div className="stat-value">{vegasCovered} / {finishedGames.length}</div>
                      <div className="stat-percent">
                        {finishedGames.length > 0 ? ((vegasCovered / finishedGames.length) * 100).toFixed(1) : 0}% Covered
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="spread-analysis">
                    ...
                    <div className="spread-comparison">
                      <div className="spread-item">
                        ...
                        {isFinished && aiWasCorrect !== null && (
                          <span className={`spread-result ${aiWasCorrect ? 'correct' : 'wrong'}`}>
                            {aiWasCorrect ? '✓' : '✗'}
                          </span>
                        )}
                      </div>
