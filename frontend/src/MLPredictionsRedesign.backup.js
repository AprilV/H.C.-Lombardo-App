      ...
      <div className="simple-legend">
        <div className="legend-item">
          ...
          <div className="legend-text">
            <strong>Elo:</strong> Rankings that track team strength game-by-game (like chess ratings)
          </div>
        </div>
        <div className="legend-item">
          <span className="legend-icon">🤖</span>
          <div className="legend-text">
            <strong>AI:</strong> Computer learns from 20+ years of games to predict outcomes
          </div>
        </div>
        <div className="legend-item">
          <span className="legend-icon">🎰</span>
          <div className="legend-text">
            <strong>Vegas:</strong> What Las Vegas sportsbooks say (the official betting line)
          </div>
        </div>
        <div className="legend-item">
          <span className="legend-icon">✅</span>
          <div className="legend-text">
            <strong>Consensus:</strong> Both Elo and AI agree on the winner (more confidence)
          </div>
        </div>
        <div className="legend-item">
          <span className="legend-icon">⚠️</span>
          <div className="legend-text">
            <strong>Split:</strong> Elo and AI pick different winners (toss-up game)
          </div>
        </div>
        <div className="legend-item">
          <span className="legend-icon">💎</span>
          <div className="legend-text">
            <strong>Value:</strong> Our prediction differs from Vegas by 3+ points (potential edge)
          </div>
        </div>
      </div>
